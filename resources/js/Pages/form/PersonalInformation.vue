  ...
  <div class="card card-custom">
    ...
    <div class="card-header py-3">
      <div class="card-title align-items-start flex-column">
        ...
        >Edita la Información del paciente</span
        >
      </div>
    ...
    <div class="card-body">
      <div class="row">
        ...
        <div class="col-lg-9 col-xl-6">
          <h5 class="font-weight-bold mb-6">Datos Básicos</h5>
        </div>
      </div>
...
<div class="form-group row">
  ...
  <div class="col-lg-9 col-xl-9">
    ...
    type="text"
    v-bind:value="currentUserPersonalInfo.first_name_1"
    />
  </div>
</div>
<div class="form-group row">
  ...
  <div class="col-lg-9 col-xl-9">
    ...
    class="form-control form-control-lg form-control-solid"
    type="text"
    v-bind:value="currentUserPersonalInfo.first_name_2"
    />
  </div>
</div>
<div class="form-group row">
  ...
  <div class="col-lg-9 col-xl-9">
    ...
    class="form-control form-control-lg form-control-solid"
    type="text"
    v-bind:value="currentUserPersonalInfo.last_name_1"
    />
  </div>
</div>
<div class="form-group row">
  ...
  <div class="col-lg-9 col-xl-9">
    ...
    class="form-control form-control-lg form-control-solid"
    type="text"
    v-bind:value="currentUserPersonalInfo.last_name_2"
    />
  </div>
</div>
<div class="form-group row">
...
import { UPDATE_PERSONAL_INFO } from "../../src/core/services/store/profile.module";
